...
while(Iteration > 0)
    ...
    //disp('-----before changing fit----'); disp(Fit); disp('----before-----');
    ...
    //disp('-----before changing clone----'); disp(Clone); disp('----before-----');
    ...
    //disp('-----before changing clone----'); disp(Clone); disp('----before-----');
   // disp('---- after changing fit'); disp(Fit);                    disp('after changing fit------');
    ...
    for i = 1:size(Clone ,1)
        Probability = [Probability; 1-(Fit(i)/sum_of_fitness)];  
    end    
